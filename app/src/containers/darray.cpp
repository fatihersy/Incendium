...
void* _darray_create(u64 length, u64 stride) {
    ...
    u64* new_array = (u64*) allocate_memory(header_size + array_size, true);
...
void* _darray_resize(void* array) {
    ...
    void* temp = _darray_create(
        ...
        stride);
    copy_memory(temp, array, length * stride);
...
void* _darray_push(void* array, const void* value_ptr) {
    ...
    u64 addr = (u64)array;
    addr += (length * stride);
    copy_memory((void*)addr, value_ptr, stride);
...
void* _darray_pop_at(void* array, u64 index, void* dest) {
    ...
    u64 stride = darray_stride(array);
    if (index >= length) {
        TraceLog(LOG_ERROR, "Index outside the bounds of this array! Length: %i, index: %index", length, index);
        return array;
    }
...
void* _darray_insert_at(void* array, u64 index, void* value_ptr) {
    ...
    copy_memory((void*)(addr + (index * stride)), value_ptr, stride);
