...
typedef struct event_context {
  data128 data;
  event_context(void) {}
  event_context(data128 in_data) {
    this->data = in_data;
  }
  event_context(i64 value1, i64 value2 = 0) { data = data128(value1, value2); }
  event_context(u64 value1, u64 value2 = 0) { data = data128(value1, value2); }
  event_context(f64 value1, f64 value2 = 0) { data = data128(value1, value2); }
...
typedef enum system_event_code {
  ...
  */
  ...
  EVENT_CODE_SET_SPAWN_TINT,
  EVENT_CODE_HALT_SPAWN_MOVEMENT,
  EVENT_CODE_DAMAGE_SPAWN_BY_ID,
  EVENT_CODE_DAMAGE_SPAWN_ROTATED_RECT,
  ...
  EVENT_CODE_PLAYER_CONSUME_MANA,
  EVENT_CODE_PLAYER_RESTORE_MANA,
