...
#define MAX_MAP_FILESIZE TILESHEET_TILE_SYMBOL_STR_LEN * MAX_TILEMAP_TILESLOT
...
enum easing_type {
  ...
  EASING_TYPE_LINEAR_OUT,
  EASING_TYPE_LINEAR_INOUT,
  EASING_TYPE_SINE_IN,
  EASING_TYPE_SINE_OUT,
  EASING_TYPE_SINE_INOUT,
  EASING_TYPE_CIRC_IN,
  EASING_TYPE_CIRC_OUT,
  EASING_TYPE_CIRC_INOUT,
  EASING_TYPE_CUBIC_IN,
  EASING_TYPE_CUBIC_OUT,
  EASING_TYPE_CUBIC_INOUT,
  EASING_TYPE_QUAD_IN,
  EASING_TYPE_QUAD_OUT,
  EASING_TYPE_QUAD_INOUT,
  EASING_TYPE_EXPO_IN,
  EASING_TYPE_EXPO_OUT,
  EASING_TYPE_EXPO_INOUT,
  EASING_TYPE_BACK_IN,
  EASING_TYPE_BACK_OUT,
  EASING_TYPE_BACK_INOUT,
  EASING_TYPE_BOUNCE_OUT,
  EASING_TYPE_BOUNCE_IN,
  EASING_TYPE_BOUNCE_INOUT,
...
typedef enum asset1_file_id {
  ...
  PAK_FILE_ASSET1_FONT_MOOD,
  PAK_FILE_ASSET1_FONT_MIOSEVKA_ITALIC,
  PAK_FILE_ASSET1_FONT_MIOSEVKA_LIGHT,
  PAK_FILE_ASSET1_FONT_MIOSEVKA_REGULAR,
  PAK_FILE_ASSET1_FONT_MIOSEVKA_BOLD,
  ...
  PAK_FILE_ASSET1_SPIN_RESULT_STAR_105_105,
  PAK_FILE_ASSET1_SPIN_SFX,
  PAK_FILE_ASSET1_SPIN_RESULT,
  PAK_FILE_ASSET1_ENTRANCE1_160x280,
  PAK_FILE_ASSET1_ENTRANCE2_160x280,
  PAK_FILE_ASSET1_ENTRANCE3_160x280,
  PAK_FILE_ASSET1_ENTRANCE4_160x280,
  PAK_FILE_ASSET1_ENTRANCE5_160x280,
  PAK_FILE_ASSET1_ENTRANCE6_160x280,
  PAK_FILE_ASSET1_ENTRANCE7_160x280,
  PAK_FILE_ASSET1_ENTRANCE8_160x280,
  PAK_FILE_ASSET1_ENTRANCE9_160x280,

  PAK_FILE_ASSET1_HARVESTER_EFFECT_517x517,
  PAK_FILE_ASSET1_HARVESTER_HEAD_455x451,
  PAK_FILE_ASSET1_HARVESTER_TRAIL_393x497,

  PAK_FILE_SIGIL_ABILITY_CD,
  PAK_FILE_SIGIL_AOE,
  PAK_FILE_SIGIL_BASIC_ATTACK_DAMAGE,
  PAK_FILE_SIGIL_BASIC_ATTACK_SPEED,
  PAK_FILE_SIGIL_CONDITION_DURATION,
  PAK_FILE_SIGIL_CRITICAL_CHANCE,
  PAK_FILE_SIGIL_CRITICAL_DAMAGE,
  PAK_FILE_SIGIL_DAMAGE_DEFERRAL,
  PAK_FILE_SIGIL_DAMAGE_OVER_TIME,
  PAK_FILE_SIGIL_DAMAGE_REDUCTION,
  PAK_FILE_SIGIL_DROP_RATE,
  PAK_FILE_SIGIL_EXP_GAIN,
  PAK_FILE_SIGIL_HEALTH,
  PAK_FILE_SIGIL_HP_REGEN,
  PAK_FILE_SIGIL_LETHAL_SIGIL_EFFECTIVENESS,
  PAK_FILE_SIGIL_MANA,
  PAK_FILE_SIGIL_MANA_REGEN,
  PAK_FILE_SIGIL_MOVE_SPEED,
  PAK_FILE_SIGIL_OVERALL_DAMAGE,
  PAK_FILE_SIGIL_OVERALL_LUCK,
  PAK_FILE_SIGIL_PROJECTILE_AMOUTH,
  PAK_FILE_SIGIL_REWARD_MODIFIER,
  PAK_FILE_SIGIL_SIGIL_EFFECTIVENESS,
  PAK_FILE_SIGIL_STAMINA_REGEN,
  PAK_FILE_SIGIL_STAMINA,
  PAK_FILE_SIGIL_TOTAL_TRAIT_POINT,
  PAK_FILE_SIGIL_VITAL_SIGIL_EFFECTIVENESS,
  PAK_FILE_ASSET1_MAX,
} asset1_file_id;
...
typedef enum texture_id {
  ...
  TEX_ID_ZAP,
  TEX_ID_SPIN_RESULT_STAR_105_105,
  TEX_ID_ENTRANCE1_160x280,
  TEX_ID_ENTRANCE2_160x280,
  TEX_ID_ENTRANCE3_160x280,
  TEX_ID_ENTRANCE4_160x280,
  TEX_ID_ENTRANCE5_160x280,
  TEX_ID_ENTRANCE6_160x280,
  TEX_ID_ENTRANCE7_160x280,
  TEX_ID_ENTRANCE8_160x280,
  TEX_ID_ENTRANCE9_160x280,

  TEX_ID_HARVESTER_EFFECT_517x517,
  TEX_ID_HARVESTER_HEAD_455x451,
  TEX_ID_HARVESTER_TRAIL_393x497,
  
  TEX_ID_SIGIL_ABILITY_CD,
  TEX_ID_SIGIL_AOE,
  TEX_ID_SIGIL_BASIC_ATTACK_DAMAGE,
  TEX_ID_SIGIL_BASIC_ATTACK_SPEED,
  TEX_ID_SIGIL_CONDITION_DURATION,
  TEX_ID_SIGIL_CRITICAL_CHANCE,
  TEX_ID_SIGIL_CRITICAL_DAMAGE,
  TEX_ID_SIGIL_DAMAGE_DEFERRAL,
  TEX_ID_SIGIL_DAMAGE_OVER_TIME,
  TEX_ID_SIGIL_DAMAGE_REDUCTION,
  TEX_ID_SIGIL_DROP_RATE,
  TEX_ID_SIGIL_EXP_GAIN,
  TEX_ID_SIGIL_HEALTH,
  TEX_ID_SIGIL_HP_REGEN,
  TEX_ID_SIGIL_LETHAL_SIGIL_EFFECTIVENESS,
  TEX_ID_SIGIL_MANA,
  TEX_ID_SIGIL_MANA_REGEN,
  TEX_ID_SIGIL_MOVE_SPEED,
  TEX_ID_SIGIL_OVERALL_DAMAGE,
  TEX_ID_SIGIL_OVERALL_LUCK,
  TEX_ID_SIGIL_PROJECTILE_AMOUTH,
  TEX_ID_SIGIL_REWARD_MODIFIER,
  TEX_ID_SIGIL_SIGIL_EFFECTIVENESS,
  TEX_ID_SIGIL_STAMINA_REGEN,
  TEX_ID_SIGIL_STAMINA,
  TEX_ID_SIGIL_TOTAL_TRAIT_POINT,
  TEX_ID_SIGIL_VITAL_SIGIL_EFFECTIVENESS,
...
typedef enum atlas_texture_id {
  ...
  ATLAS_TEX_ID_CURRENCY_SOUL_ICON,
  ATLAS_TEX_ID_CURRENCY_COIN_ICON,
  ATLAS_TEX_ID_FOG,
  ATLAS_TEX_ID_PANEL_SCROLL,
  ATLAS_TEX_ID_PANEL_SCROLL_HANDLE,
  ATLAS_TEX_ID_CHEST_BASE,
  ATLAS_TEX_ID_CHEST_LID,
  ATLAS_TEX_ID_SIGIL_DAMAGE_COMMON,
  ATLAS_TEX_ID_SIGIL_DAMAGE_UNCOMMON,
  ATLAS_TEX_ID_SIGIL_DAMAGE_RARE,
  ATLAS_TEX_ID_SIGIL_DAMAGE_EPIC,
  ATLAS_TEX_ID_SIGIL_RESISTANCE_COMMON,
  ATLAS_TEX_ID_SIGIL_RESISTANCE_UNCOMMON,
  ATLAS_TEX_ID_SIGIL_RESISTANCE_RARE,
  ATLAS_TEX_ID_SIGIL_RESISTANCE_EPIC,
  ATLAS_TEX_ID_SCISSER_BLADE,
  ATLAS_TEX_ID_MAX,
} atlas_texture_id;
...
typedef enum spritesheet_id {
  ...
  SHEET_ID_ENTRANCE1_ANIMATION,
  SHEET_ID_ENTRANCE2_ANIMATION,
  SHEET_ID_ENTRANCE3_ANIMATION,
  SHEET_ID_ENTRANCE4_ANIMATION,
  SHEET_ID_ENTRANCE5_ANIMATION,
  SHEET_ID_ENTRANCE6_ANIMATION,
  SHEET_ID_ENTRANCE7_ANIMATION,
  SHEET_ID_ENTRANCE8_ANIMATION,
  SHEET_ID_ENTRANCE9_ANIMATION,

  SHEET_ID_HARVESTER_EFFECT,
  SHEET_ID_HARVESTER_HEAD,
  SHEET_ID_HARVESTER_TRAIL,
  ...
  SHEET_ID_SPIN_RESULT_STAR_105_105,
...
typedef enum button_id {
  ...
  BTN_ID_MAINMENU_SAVE_GAME_SAVE,
  BTN_ID_MAINMENU_SAVE_GAME_LOAD,
