...
typedef enum atlas_texture_id {
  ...
  ATLAS_TEX_ID_RUNE_DAMAGE_COMMON,
  ATLAS_TEX_ID_RUNE_DAMAGE_UNCOMMON,
  ATLAS_TEX_ID_RUNE_DAMAGE_RARE,
  ATLAS_TEX_ID_RUNE_DAMAGE_EPIC,
  ATLAS_TEX_ID_RUNE_RESISTANCE_COMMON,
  ATLAS_TEX_ID_RUNE_RESISTANCE_UNCOMMON,
  ATLAS_TEX_ID_RUNE_RESISTANCE_RARE,
  ATLAS_TEX_ID_RUNE_RESISTANCE_EPIC,
  ATLAS_TEX_ID_MAX,
} atlas_texture_id;
