...
constexpr Rectangle se_get_camera_view_rect(Camera2D camera);
...
constexpr Rectangle se_get_camera_view_rect(Camera2D camera) {
  ...
  f32 view_width = SE_BASE_RENDER_WIDTH / camera.zoom;
  f32 view_height = SE_BASE_RENDER_HEIGHT / camera.zoom;
